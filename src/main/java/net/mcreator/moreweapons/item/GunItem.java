...
import net.mcreator.moreweapons.entity.renderer.GunRenderer;
import net.mcreator.moreweapons.MoreWeaponsModElements;

import java.util.Random;

@MoreWeaponsModElements.ModElement.Tag
public class GunItem extends MoreWeaponsModElements.ModElement {
	@ObjectHolder("more_weapons_:gun")
	...
	public GunItem(MoreWeaponsModElements instance) {
		super(instance, 4);
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(MoreWeaponsItemGroup.tab).maxDamage(500));
			setRegistryName("gun");
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 2f, 1.5, 3);
	...
	public static ArrowCustomEntity shoot(World world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		...
		world.playSound((PlayerEntity) null, (double) x, (double) y, (double) z,
				(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("more_weapons_:gun_go_brrrrrrrrr")),
