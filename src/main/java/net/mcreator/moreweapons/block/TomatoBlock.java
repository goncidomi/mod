...
import net.mcreator.moreweapons.item.TomatololItem;
...
public class TomatoBlock extends MoreWeaponsModElements.ModElement {
	@ObjectHolder("more_weapons_:tomato")
	public static final Block block = null;
	public TomatoBlock(MoreWeaponsModElements instance) {
		super(instance, 51);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("tomato"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("more_weapons_:tomato"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(TomatololItem.block, (int) (1)));
		}
