...
public class HeatoreBlock extends MoreWeaponsModElements.ModElement {
	@ObjectHolder("more_weapons_:heatore")
	public static final Block block = null;
	public HeatoreBlock(MoreWeaponsModElements instance) {
		super(instance, 60);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(3.0999999999999996f, 12f)
					.setLightLevel(s -> 0));
			setRegistryName("heatore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("more_weapons_:heatore_match"), () -> CustomRuleTest.codec);
